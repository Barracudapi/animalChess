...
public class Board {
    ...
    public static final Spot[][] INITIAL_SPOTS = {
            {new Spot(1,1, new Lion(Piece.Color.RED, "LION", 8), Spot.Type.LAND), new Spot(1,2, new Leopard(Piece.Color.RED, "LEOPARD",5 ), Spot.Type.LAND), new Spot(1,3, new Lion(Piece.Color.YELLOW, "LION", 8), Spot.Type.TRAPRED), new Spot(1,4, null, Spot.Type.BASERED), new Spot(1,5, null, Spot.Type.TRAPRED), new Spot(1,6, null, Spot.Type.LAND), new Spot(1,7, new Tiger(Piece.Color.RED, "TIGER", 7), Spot.Type.LAND)},
